...
const Skills = () => {
  return (
    <section id="skills" className="sticky-section sticky-layer" style={{ position: 'relative', backgroundColor: 'var(--color-panel)', height: '100dvh', width: '100%', overflow: 'hidden' }}>
