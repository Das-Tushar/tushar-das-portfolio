    ...
    >
      ...
      <motion.div variants={childVariants}>
        <div className="projects-gallery" style={{ maxWidth: '1100px', margin: '0 auto', width: '100%', padding: '1rem 0 2rem 0' }}>
            ...
            <div className="project-content" style={{ padding: '2.5rem', flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '0.5rem', flexWrap: 'wrap', gap: '1rem' }}>
                ...
                <div className="project-actions">
                  <motion.a
                    href="https://cs-nexus.vercel.app"
                    target="_blank"
                  ...
                  <motion.a
                    href="https://github.com/Das-Tushar/cs-nexus.git"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Explore More Card */}
          <SpotlightCard className="project-card" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            <div className="project-content" style={{ textAlign: 'center', padding: '3rem' }}>
              ...
              <motion.a
                href="https://github.com/Das-Tushar?tab=repositories"
                target="_blank"
                rel="noopener noreferrer"
                className="btn-project btn-github"
                style={{ display: 'inline-block', padding: '0.8rem 2rem' }}
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
